...
// Per-creator media caps — one cover photo, one reel. Keeps profiles light and
// forces creators to lead with their best work.
...
export const SUBCATEGORIES: Record<string, string[]> = {
  ...
  dancers: ["Bollywood Dancers", "Contemporary Dancers", "Hip-Hop Dancers", "Ballet Dancers", "Salsa Dancers", "Latin Dancers", "Belly Dancers", "Arabic Dancers", "Kathak Dancers", "Classical Indian Dancers", "Fusion Dancers", "LED Dancers", "Fire Dancers", "Wedding Dance Groups", "Kids Dance Groups"],
  ...
  entertainers: ["Stilt Walkers", "Mascot Performers", "Balloon Artists", "Juggling Artists", "Fire Performers", "Puppeteers", "Street Performers", "Mime Artists", "Living Statues", "Bubble Artists"],
